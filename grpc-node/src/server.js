...
const categoryRepo = require('./database/repository/category');


categoryRepo.createCategory({ name: 'Movie', description: 'test' }).then(console.log).catch(err => console.log(err));
